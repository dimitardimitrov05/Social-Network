        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountPrivacy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfSendingFriendship = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserThatSendTheFriendship = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    RemovingFriendship = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRegistratedFromInvite = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "528726ea-e421-4a80-b303-f035355599de", "a96a0a07-c2c8-4b18-8e19-acb88b5ab8a7", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "5dd65fa9-eb2c-4372-8084-8c501347e74f", "84b79350-d2cc-47a3-8807-fd286653ed73", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AccountPrivacy", "ConcurrencyStamp", "DateOfBirth", "Email", "EmailConfirmed", "FirstName", "Gender", "Image", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "14ca9c85-3b2c-43e8-a626-53b1a223233b", 0, "Public", "9eeb17df-76b3-4647-9b8c-4fc8ec988ed0", new DateTime(2005, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmai.com", false, "Dimitar", "Male", null, "Dimitrov", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEEUTAuOQWwV0x+2CvtWu0jUSBD1Fm6THXIMz5ktvbfr0pUczshB/PesZOawqHS5eaQ==", null, false, "a50a3a14-a8d2-4840-82bb-abe46598a5b5", false, "admin" });
